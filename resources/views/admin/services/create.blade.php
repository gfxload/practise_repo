            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.services.store') }}" class="space-y-6" enctype="multipart/form-data">
                        ...
                        <div class="flex items-center">
                            <input id="is_video" name="is_video" type="checkbox" class="rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500">
                            <label for="is_video" class="ml-2 block text-sm text-gray-900">This service is for videos</label>
                        </div>

                        <!-- Video Options Section -->
                        <div id="video-options-section" class="hidden space-y-6 border p-4 rounded-lg bg-gray-50">
                            ...
                            <div class="bg-yellow-50 p-3 rounded-md mb-4 border border-yellow-200">
                                <p class="text-sm text-yellow-800">
                                    <strong>Important:</strong> You must click the "Add Option" button below to add at least one video option.
                                    Without video options, users won't be able to select video quality when downloading.
                                </p>
                            </div>
                            
                            <div id="video-options-container">
                                <!-- Template for video options -->
                            </div>
                            ...
                            <button type="button" id="add-video-option" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700">
                                Add Option
                            </button>
                        </div>
        ...
        <div class="video-option border p-3 rounded-md mb-4 bg-white">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="video_options[INDEX][points_cost]" min="0" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="e.g. 0" value="0" required>
