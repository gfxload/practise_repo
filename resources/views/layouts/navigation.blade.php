<nav x-data="{ open: false }" class="w-64 bg-white border-r border-gray-100 pt-5 pb-4 flex flex-col">
    <!-- Logo -->
            ...
            <div class="mt-8">
                ...
                <div class="space-y-3">
                    ...
                    <x-responsive-nav-link :href="route('admin.users.index')" :active="request()->routeIs('admin.users.*')">
                        <x-slot name="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.1" />
                            </svg>
                        </x-slot>
                        {{ __('Users') }}
                    </x-responsive-nav-link>
                    ...
                    <x-responsive-nav-link :href="route('admin.services.index')" :active="request()->routeIs('admin.services.*')">
                        <x-slot name="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z" />
                            </svg>
                        </x-slot>
                        {{ __('Services') }}
                    </x-responsive-nav-link>
                    ...
                    <x-responsive-nav-link :href="route('admin.settings.download')" :active="request()->routeIs('admin.settings.*')">
                        <x-slot name="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white">
            <div class="flex-shrink-0 px-4">
                <div class="flex items-center">
                    ...
                    <span class="mr-2 text-gray-900 font-semibold">{{ config('app.name', 'Laravel') }}</span>
                </div>
            </div>
